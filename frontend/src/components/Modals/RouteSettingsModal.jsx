...
export default function RouteSettingsModal({handleLoading}) {
  ...
  const [errors, setErrors] = useState({})
    ...
    const handleSubmit = (e) => {
        // setTime({...time, route: from+ '-' +to})
        e.preventDefault()
        setBtnLoading(true)
        axiosClient.post('/settings/time/store', time)
            .then(({data}) => {
                setErrors([]);
                setBtnLoading(false)
                handleLoading()
  ...
  return (
      <form onSubmit={handleSubmit}>
        ...
        <TERipple rippleColor="white">
          <button
            type="button"
            className="mb-5 inline-block rounded bg-blue-500 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
            ...
            <TEModalContent>
              ...
              <TEModalBody>
                ...
                <div className='grid grid-cols-2 gap-5 p-5'>
                        ...
                        <label htmlFor="" className='text-gray-500'>Departure Time</label>
                        <input
                    ...
                    <div className='w-full mb-5'>
                        <label htmlFor="" className='text-gray-500'>Boarding</label>
                        <input
                            // defaultValue={`${times ? times.departure: ''}`} 
                    ...
                    <div className='w-full mb-5'>
                        ...
                        />
                        {
                            errors.route ? <p className="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oh, snapp!</span> {errors.route}</p>
                            : null
                        }
                    </div>
                    <div className='w-full mb-5'>
