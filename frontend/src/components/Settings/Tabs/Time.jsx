...
export default function Time({handleLoading, times}) {
    ...
    <div className='p-5'>
        ...
        <div className='py-3 w-full mb-2 border-b border-gray-200'>
            <div className='flex items-center gap-5 justify-between w-[80%]'>
                <h1 className='text-gray-500 text-md font-2xl'>Departure:</h1>
                <div>
                    <div class="flex">
                        ...
                        <input
                            ...
                            className={` ${errors.departure ? 'border-red-500' : 'border-gray-300'} border  text-gray-900 text-sm rounded-none rounded-r-lg focus:ring-blue-500 focus:border-blue-500 block w-[500px] p-2.5 `}
                        />
                        </div>
                    </div>
                    {
        ...
        <div className='py-3 w-full mb-2 border-b border-gray-200'>
            <div className='flex items-center gap-5 justify-between w-[80%]'>
                <h1 className='text-gray-500 text-md font-2xl'>Boarding:</h1>
                <div>
                    <div class="flex">
                        <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                            <FaIcon.FiClock/>
                        ...
                        <div>
                        <input
                             defaultValue={`${times ? times.boarding: ''}`} 
                            onChange={ev => setTime({...time, boarding: ev.target.value})} 
                            type="time" id="first_name" 
                            className={` ${errors.boarding ? 'border-red-500' : 'border-gray-300'} border  text-gray-900 text-sm rounded-none rounded-r-lg focus:ring-blue-500 focus:border-blue-500 block w-[500px] p-2.5 `}
                        />
                        </div>
                    </div>
                    {
