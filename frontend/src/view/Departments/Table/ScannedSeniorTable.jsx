...
export default function ScannedSeniorTable() {
    ...
    useEffect(() => {
        axiosClient.get(`/get-scanned-depertment-seniors/${limit}/${barangay}?page=${paginate}`)
        .then(({data}) => {
                        ...
                        <tbody>
                            ...
                            .map(u => (
                                ...
                                <td className='text-md px-5 py-2 font-medium flex gap-5 items-center'>
                                    <div>
                                        <span className='text-gray-500'>{u.last_name + ' ' + u.first_name}</span> <br />
                                ...
                                <td className='text-md px-5 py-2x text-gray-500'>{u.date}</td>
                                <td>
