...
export default function AddDepartmentStaff({hideModal, handleLoading, departmentId}) {
    ...
    function submitUser(ev) {
        ...
        setLoading(true)
        setErrors([])
        axiosClient.post(`/staff/department/store/${departmentId}`, userInfo, config)
            .then(({data}) => {
                if(data === 422){
                    setErrors({
                ...
                <div className='mt-5 flex items-center justify-center'>
                    <form class="w-full" onSubmit={submitUser}>
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6 mt-6">
                            ...
                            <input 
                                onChange={ev => setUserInfo({...userInfo, position: ev.target.value})}
                                id="grid-last-name" 
                                type="text" 
                                ...
                                />
                                {errors.position ? <p class="text-red-500 text-xs italic">{errors.position}</p> : null}
                            </div>
                        </div>
                        <div className="flex flex-wrap -mx-3 mb-6 mt-6">
                            <div className="w-full px-3">
