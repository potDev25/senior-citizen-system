...
export default function UpdatePassenger({hideModal, handleLoading, showMediaModal, announcement}) {
    ...
    function submitUser(ev) {
        ev.preventDefault();
        setLoading(true)
        axiosClient.put(`/announcement/edit/${announcement.id}`, userInfo)
            .then(({data}) => {
                setLoading(false)
                setNotification('Announcements Edited Successfully')
                setErrors([])
                setTimeout(function() {
                    ...
                    <form class="w-full" onSubmit={submitUser}>
                        <div className="flex flex-wrap -mx-3 mb-6 mt-6">
                            ...
                            <div className="relative">
                                ...
                                >
                                    {announcement.type ? 
                                        <option value={announcement.type} selected>{announcement.type}</option> : null
                                    }
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6 mt-6">
                            ...
                            <div className="relative">
                                <select onChange={ev => setUserInfo({...userInfo, recipent: ev.target.value})} 
                                    ...
                                    id="grid-state"
                                >
                                    {announcement.recipents ? 
                                        <option value={announcement.recipents} selected>{announcement.recipents}</option> : null
                                    }
                            ...
                            announcement.type === 'Event' || type ? <>
                                <div className="flex flex-wrap -mx-3 mb-6 mt-6">
                                    ...
                                    <input 
                                        ...
                                        type="datetime-local" 
                                        placeholder="Doe"
                                        defaultValue={announcement.act_date}
