...
export default function UpdatePassengerModal({handleLoading, show, hideModal, passenger, announcements}) {
          ...
          <TEModalDialog size='lg' centered >
            <TEModalContent>
              <TEModalHeader className=' text-white'>
                {/* <!--Modal title--> */}
                    <h1 className='uppercase text-2xl text-gray-900 flex items-center'><FaIcon.FiEdit/> &nbsp;edit announcement information</h1>
                {/* <!--Close button--> */}
                <button
                  type="button"
                  className="box-content text-gray-900 rounded-none border-none hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none"
