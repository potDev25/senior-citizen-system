...
export default function AddStaffModal({handleLoading, show, hideModal, dateId, passenger, barangays}) {
          ...
          <TEModalDialog size='lg' centered >
            <TEModalContent>
              <TEModalHeader className='bg-white text-white'>
                {/* <!--Modal title--> */}
                    <h1 className='uppercase text-2xl text-gray-500 flex items-center'><FaIcon.FiPlusCircle/> &nbsp;add user</h1>
                {/* <!--Close button--> */}
                <button
                  type="button"
